...
First, use the latest CTC Traders API Test Pack to test your software is compatible with our API. You must test some sample scenarios using test data for both Great Britain and Northern Ireland.
...
You can use the cURL commands to simulate:
