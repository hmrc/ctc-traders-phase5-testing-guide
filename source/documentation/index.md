...
**Note:** The phasing of accreditation testing means that you will need to make 2 applications for CTC Traders API v2.0 production credentials. For more information about this, see [Apply for production credentials](documentatioon/apply-for-production-credentials.html).
